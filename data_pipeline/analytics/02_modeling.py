...
joblib.dump(best_pipeline, "analytics/model_pipeline.pkl")
print(
    "\nSaved complete pipeline to analytics/model_pipeline.pkl successfully!"
)

# Verify reload
loaded_pipeline = joblib.load("analytics/model_pipeline.pkl")
